document.addEventListener("DOMContentLoaded", () => {
  document.body.insertAdjacentHTML("afterbegin", `
     <nav class="nav">
      ...
      <div class="nav__menu">
        <ul>
          <li class="nav__menu__link"><a href="index.html#about">About</a></li>
          <li class="nav__menu__link"><a href="index.html#research">Research</a></li>
          <li class="nav__menu__link"><a href="index.html#publications">Publications</a></li>
